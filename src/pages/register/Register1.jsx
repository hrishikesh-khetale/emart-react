    ...
    <>
      <Formik
        initialValues={{
          ...
          custEmail: "",
          custPassword: "",
          cardHolder: false, // Initialize as false
          confirm_password: "",
          Points: 0,
          cart: null
        }}
        onSubmit={async (values, { setSubmitting }) => {
          // Convert cardHolder to boolean
          values.cardHolder = values.cardHolder === "true";

          console.log(values);
          try {
            const res = await axios.post("http://localhost:5062/api/Customer", values);
            ...
            <div className="bg-light min-vh-100 p-5 m-5">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <select
                  id="cardHolder"
                  name="cardHolder"
                  value={values.cardHolder.toString()} // Convert boolean to string
                  onChange={handleChange}
                  onBlur={handleBlur}
